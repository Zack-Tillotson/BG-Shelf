...
import { Member, Club, Item, Acquisition, Session, Ownership } from 'data/objectCreator'
...
const member = new Member('member1', {name: 'Billy Willy Slams'})
const club = new Club({name: 'Test Club #2'})
