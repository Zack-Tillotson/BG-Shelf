...
const ownership1 = new Ownership(item1)
ownership1.acquisitions.push(new Acquisition({ 
  date: '2021-10-01',
  price: "$40",
}))
ownership1.acquisitions.push(new Acquisition({ 
...
const ownership2 = new Ownership(item2)
ownership2.attributes.collection = true

const ownership3 = new Ownership(item3)
ownership3.attributes.collection = true
ownership3.attributes.wishlist = true

const member = new Member('member1', {name: 'Alice McGee'})
const club = new Club({name: 'Test Club #1'})

club.sessions.push(new Session(item1, {participants: ['Alice', 'Bob', 'Charlie', 'Dan', 'Erin']}))
club.sessions.push(new Session(item2, {participants: ['Alice McGee', 'Bob Longnamington', 'Charlie The Man Dude', 'Dan', 'Erin Erinovicherinly']}))
